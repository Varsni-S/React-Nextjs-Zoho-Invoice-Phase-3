...
const client = new OAuth2Client("120376179753-f17hpj1k72savg4jgs99a8ii29kpsjsv.apps.googleusercontent.com");
...
var functions = {
  ...
  LoginUserGoogle: async (req, res) => {
    ...
    await client
      .verifyIdToken({
        idToken: tokenid,
        audience:"120376179753-f17hpj1k72savg4jgs99a8ii29kpsjsv.apps.googleusercontent.com",
      })
      .then((response) => {
